...
*More than 43 percent of grants/contracts listed were reported as losing more than or half of the its initial worth*
...
(13 / 30) * 100 # quick percentage of total contracts/grants
...
college_park_cuts <- college_park_cuts |>
  mutate(
    description = str_to_sentence(description),
    providing_agency = str_to_sentence(providing_agency),
    type = str_to_sentence(type)
  ) |>
  select(-vendor, -full_details)

# making it a csv for viz
write_csv(college_park_cuts, "data/college_park_cuts.csv")
